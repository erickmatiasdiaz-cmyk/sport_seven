    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <header className="bg-gradient-to-b from-[#F7931E] to-[#FF8C2A] text-white shadow-lg">
        <div className="max-w-[420px] mx-auto px-6 py-6 pb-8 rounded-b-3xl">
          <Link href="/login" className="inline-flex items-center mb-4 text-white/80 hover:text-white">
          ...
          <p className="text-white/80 text-sm mt-1">Únete a Sport Seven</p>
        </div>
      </header>
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm">
          ...
          <div className="mt-6 text-center">
            <p className="text-[#6B7280] text-sm">
              ¿Ya tienes cuenta?{' '}
              <Link href="/login" className="text-[#F7931E] font-medium hover:underline">
                Inicia sesión
              </Link>
            </p>
          </div>
